...
export function ExportProjectArchive(arg1:app.SpectraExportRequest):Promise<string>;

export function FinishDatabaseRestore(arg1:app.DatabaseRestoreRequest):Promise<app.DatabaseRestoreResult>;

export function FinishProjectImport(arg1:app.SpectraImportRequest):Promise<app.SpectraImportResult>;
...
export function ImportProjectArchive():Promise<app.SpectraImportResult>;
...
export function RelaunchApplication():Promise<void>;

export function RestoreDatabaseFromBackup():Promise<app.DatabaseRestoreResult>;
