...
export function AppChannel() {
  return window['go']['app']['App']['AppChannel']();
}

export function AppPlatform() {
  return window['go']['app']['App']['AppPlatform']();
}
...
export function ExportProjectArchive(arg1) {
  return window['go']['app']['App']['ExportProjectArchive'](arg1);
}

export function FinishDatabaseRestore(arg1) {
  return window['go']['app']['App']['FinishDatabaseRestore'](arg1);
}

export function FinishProjectImport(arg1) {
  return window['go']['app']['App']['FinishProjectImport'](arg1);
}
...
export function ImportProjectArchive() {
  return window['go']['app']['App']['ImportProjectArchive']();
}
...
export function RelaunchApplication() {
  return window['go']['app']['App']['RelaunchApplication']();
}

export function RestoreDatabaseFromBackup() {
  return window['go']['app']['App']['RestoreDatabaseFromBackup']();
}
